...
export default function GeneratePage() {
  ...
  return (
    <div className="h-screen bg-gray-100">
        {/* Header */}
         <div
            className="h-[50px] bg-white px-6 flex items-center justify-between mb-[2px]"
        ...
        {/* Main Panel */}
         <div className="w-full h-[calc(100%-52px)] bg-white shadow-lg rounded-lg flex flex-col md:flex-row">
      {/* Left Side */}
