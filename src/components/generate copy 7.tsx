...
//     try {
//       const response = await fetch("/api/download/generated-file.docx");
...
//       saveAs(blob, "Migration_Strategy_Guide.docx");
//     } catch (error) {
...
const handleDownload = async () => {
  ...
  return (
    <div className="h-screen bg-gray-100">
      {/* Header */}
      <div
        className="h-[50px] bg-white px-6 flex items-center justify-between"
        style={{ boxShadow: '0px 0px 11px #00000014' }}
      >
      ...
      {/* Main Panel */}
      <div
        className="w-full h-[calc(100%-50px)] bg-white rounded-lg flex flex-col md:flex-row gap-[25px] pl-[20px] pr-[20px] "
        
      >
        {/* Left Side */}
        <div className="md:w-[60%] w-full bg-white rounded-lg p-6" 
        style={{ boxShadow: "0px 0px 11px #00000014" }}>
        ...
        {/* Right Side */}
        <div className="md:w-[40%] w-full bg-white rounded-lg p-6"
            style={{ boxShadow: "0px 0px 11px #00000014" }}>
